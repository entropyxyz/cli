import { findAccountByAddressOrName, getTokenDetails, print, round, tokensToBits } from "src/common/utils"
...
export async function entropyBalance (entropy, endpoint, storedConfig) {
  try {
    ...
    const balance = round(tokensToBits(tokensBalance, decimals))
